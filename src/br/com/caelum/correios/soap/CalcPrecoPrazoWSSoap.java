...
public interface CalcPrecoPrazoWSSoap {
    ...
    @RequestWrapper(localName = "calcPrazoNovo", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.soap.CalcPrazoNovo")
    @ResponseWrapper(localName = "calcPrazoNovoResponse", targetNamespace = "http://tempuri.org/", className = "br.com.caelum.correios.soap.CalcPrazoNovoResponse")
